...
// where the first element is the sum of those numbers, and
...
function testSum(x,y) {
	var sumTwoNumbers = [(x + y), 'The sum of ' + x + ' and ' + y + ' is ' + (x + y)+ '.']
...
function testMultiply(x,y) {
  var productTwoNumbers = [(x * y), 'The product of ' + x + ' and ' + y + ' is ' + (x * y) + '.']
...
function testSumAndMultiply(x,y,z) {
  var sumAndMultiplyThreeNumbers = [(x + y + z), (x * y * z), x + ' and ' + y + ' and ' + z + ' sum to ' + (x + y + z) + '.', 'The product of ' + x + ' and ' + y + ' and ' + z + ' is ' + (x * y * z) + '.']
  return sumAndMultiplyThreeNumbers;
}
...
function testSumArray(array) {
  var addArray = [(array[0] + array[1] + array[2]), array[0] + ',' + array[1] + ',' + array[2] + ' was passed in as an array of numbers, and ' + (array[0] + array[1] + array[2]) + ' is their sum.']
  return addArray;
}
...
function testMultiplyArray(array) {
  var multiplyArray = [(array[0] * array[1] * array[2]), 'The numbers ' + array[0] + ',' + array[1] + ',' + array[2] + ' have a product of ' + (array[0] * array[1] * array[2]) + '.']
